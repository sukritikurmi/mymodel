...
df = pd.read_csv(os.path.join(APP_PATH, os.path.join("data", "yty_data_.csv")))
df=df.drop(['LOG_DATE', 'LINE', 'SKU',
       'ACID_TANK_1', 'ACID_TANK_2', 'RINSING_TANK_1',
       'RINSING_TANK_2', 'ALKALINE_TANK_1', 'ALKALINE_TANK_2',
       'RINSING_TANK_3',
       'COAGULANT_TANK_SIDE_A', 'COAGULANT_TANK_SIDE_B', 'LATEX_TANK_1_SIDE_A',
       'LATEX_1_OVEN_1', 'LATEX_TANK_2_SIDE_A',
       'LATEX_TANK_2_SIDE_B', 'LATEX_2_OVEN', 'PRE_LEACH_TANK_01', 'PRE_LEACH_TANK_03', 'PRE_LEACH_TANK_04',
       'PRE_LEACH_TANK_05', 'PRE_LEACH_TANK_06', 'PRE_LEACH_TANK_07', 'PRE_LEACH_TANK_09',
       'WET_OVEN_1', 'WET_OVEN_2', 'WET_OVEN_3', 'WET_OVEN_4', 'DRY_OVEN_1',
       'DRY_OVEN_2', 'DRY_OVEN_3', 'DRY_OVEN_4', 'COOLING_TANK_01',
       'COOLING_TANK_02', 'COOLING_TANK_03', 'COOLING_TANK_04',
       'COOLING_TANK_05', 'CHLORINATION_TANK', 'SOAK_TANK',
       'NEUTRALIZER_TANK_01', 'NEUTRALIZER_TANK_02', 'POST_LEACH_TANK_04',
       'POST_LEACH_TANK_03', 'POST_LEACH_TANK_02', 'POST_LEACH_TANK_01', 'LN_TANK',
       'FINAL_CURING_OVEN_2', 'COAGULANT_OVEN_RH', 'COAGULANT_OVEN_RH_1',
       'WET_OVEN_RH', 'WET_OVEN_RH_1', 'WET_OVEN_RH_2', 'WET_OVEN_RH_3',
       'FINAL_CURING_OVEN_RH', 'FINAL_CURING_OVEN_RH_1', 'Fail', 'Pass',
